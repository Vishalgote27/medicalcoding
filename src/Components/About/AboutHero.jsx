...
import contactImage from '../../assets/Abouthero.png'; // Make sure to replace this with your actual image path

const AboutHero = () => {
  return (
    <section
      className="relative
       h-[300px] sm:h-[300px] md:h-[350px] bg-cover bg-center bg-no-repeat"
